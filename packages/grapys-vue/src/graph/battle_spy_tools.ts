...
export const graphChat: GraphData = {
  ...
  nodes: {
    ...
    submit: {
      ...
      params: {},
      inputs: {
        url: "https://dev.aq-world.singularitybattlequest.club/api/${:gameid}/submit_hint",
        body: {
          hint: ":arg.hint",
    ...
    data: {
      nodes: [
        ...
        },
        {
          ...
          type: "computed",
          position: {
            x: 332.34420354120834,
            y: 289.63439085065426,
            width: 144,
            height: 168,
        ...
        },
        {
          ...
          type: "static",
          position: {
            x: 37.796574596396226,
            y: 396.25551654363744,
            width: 144,
            height: 243,
            inputCenters: [56],
            outputCenters: [36],
        ...
        },
        {
          ...
          type: "computed",
          position: {
            x: 1046.7906895487015,
            y: 456.06052192260245,
            width: 144,
            height: 136,
            inputCenters: [60, 76, 92],
            outputCenters: [],
          },
        },
      ],
